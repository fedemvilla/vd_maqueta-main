...
<!-- Título -->
<h1 style="text-align: center; margin-bottom: 50px; margin-right:50px; margin-left:50px">"Corea vs EEUU: Duelo en el Tiro con Arco Olímpico (2008-2024)"</h1>
...
<p style=" margin-top: 20px; margin-bottom: 50px; margin-right:50px; margin-left:50px">En la visualización, cada flecha representa el desempeño de un país en un año olímpico específico. La diana simboliza el objetivo máximo de 100 puntos, con las posiciones de las flechas mostrando cuán cerca estuvieron de alcanzar la perfección en cada edición de los Juegos.</p>
...
<p style="margin-top: 50px; margin-right:50px; margin-left:50px">Desde los Juegos Olímpicos de 2008 hasta 2024, Corea del Sur y Estados Unidos han sido los principales contendientes en tiro con arco. Estos países han dominado el medallero, con una rivalidad que se ha intensificado a lo largo de los años.</p>

<!-- Contenedor para la visualización de Flourish -->
<div class="fl_container" style="width: 80%; height: 500px; margin: 0 auto; margin-top: 50px; margin-botton: 100px; text-align: center;">
...
<div style="margin-top: 50px; margin-right:50px; margin-left:50px">
  ...
  <p style="margin-bottom: 30px">En los Juegos Olímpicos de 2008 en Beijing, Corea del Sur reafirmó su supremacía en tiro con arco, alcanzando 88 puntos y asegurando varias medallas de oro. Estados Unidos, aunque competitivo, quedó rezagado con 75 puntos, comenzando a notar la brecha entre ellos y los surcoreanos.</p>
  <div class="fl_container" style="width: 80%; height: 300px; margin: 0 auto; margin-top: 50px; margin-botton: 100px; text-align: center;">
  ...
  <p style="margin-bottom: 5px"><strong>2012: La Rivalidad se Intensifica</strong></p>
  <p style="margin-bottom: 30px">En Londres 2012, Corea del Sur mejoró su desempeño, alcanzando 93 puntos, mientras que Estados Unidos también subió su nivel, logrando 82 puntos. Este fue un año en el que la rivalidad se intensificó, con ambos países luchando por cada medalla.</p>
  <div class="fl_container" style="width: 80%; height: 300px; margin: 0 auto; margin-top: 50px; margin-botton: 100px; text-align: center;">
  ...
  <p style="margin-bottom: 5px"><strong>2016: La Consistencia de Corea del Sur</strong></p>
  <p style="margin-bottom: 30px">Durante los Juegos Olímpicos de 2016 en Río, Corea del Sur casi alcanzó la perfección con 95 puntos, consolidando su dominio. Estados Unidos, a pesar de mantener un buen nivel, no pudo seguir el ritmo y terminó con 78 puntos. Este año reafirmó a Corea del Sur como la potencia indiscutible en tiro con arco.</p>
  <div class="fl_container" style="width: 80%; height: 300px; margin: 0 auto; margin-top: 50px; margin-botton: 100px; text-align: center;">
  ...
  <p style="margin-bottom: 5px"><strong>2020: La Diferencia se Amplía</strong></p>
  <p style="margin-bottom: 30px">En Tokio 2020, Corea del Sur continuó su racha de excelencia con 97 puntos, acercándose aún más al puntaje perfecto. Estados Unidos, por otro lado, vio una caída en su desempeño, alcanzando solo 70 puntos. La brecha entre ambos países se hizo más evidente, reflejando la consistencia y precisión de los arqueros surcoreanos.</p>
  <div class="fl_container" style="width: 80%; height: 300px; margin: 0 auto; margin-top: 50px; margin-botton: 100px; text-align: center;">
  ...
  <p style="margin-bottom: 5px"><strong>2024: La Perfección Alcanzada</strong></p>
  <p style="margin-bottom: 30px">En los Juegos Olímpicos de París 2024, Corea del Sur finalmente alcanzó casi la perfección con 99 puntos, estableciendo un récord en la historia del tiro con arco. Estados Unidos, a pesar de su esfuerzo, continuó su declive con 67 puntos. Este año marcó el clímax de la rivalidad, con Corea del Sur consolidando su estatus como la nación más dominante en la historia del tiro con arco olímpico.</p>
  <div class="fl_container" style="width: 80%; height: 300px; margin: 0 auto; margin-top: 50px; margin-botton: 100px; text-align: center;">
